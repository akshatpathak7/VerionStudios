...
export const metadata: Metadata = {
  ...
  description: "How Verion Studios handles website visits and information shared through email inquiries."
};

export default function PrivacyPolicy() {
  return <LegalLayout title="Privacy policy">
    <p>This policy explains how Verion Studios handles information when you visit this website or contact us about our services.</p>
    ...
    <section><h2>Website hosting and email</h2><p>This website is hosted on Vercel. Our hosting and email providers process information needed to deliver their services. Hosting may involve technical information such as IP addresses, browser details, and request logs for operation and security. See <a href="https://vercel.com/legal/privacy-notice">Vercel’s privacy notice</a> for information about its practices.</p><p>The current website does not include a contact form, advertising trackers, or an application analytics integration. Email links open your email application. Hosting and security services may have their own technical storage or logging behavior.</p></section>
