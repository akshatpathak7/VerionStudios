 ...
 return <div id="top" className={paused?"site motion-paused":"site"}>
  ...
  <main id="main">
   <section className="hero wrap" aria-labelledby="hero-title">
    <div className="eyebrow"><span className="red-square"/> VIDEO EDITING & WEB DEVELOPMENT</div>
    <div className="hero-heading"><h1 id="hero-title">Give your next video<br/><span>a reason to be watched</span></h1><span className="hero-asterisk" aria-hidden="true">✳</span></div>
    <div className="hero-bottom"><p>{studio.intro}</p><div className="hero-actions"><a className="button button-red" href="#contact">Start a project <ArrowUpRight size={19}/></a><a className="text-link" href="#editing">View our services <ArrowDown size={16}/></a></div></div>
    ...
    <div className="frame-caption"><span>ILLUSTRATIVE EDITING TIMELINE</span><button className="motion-toggle" onClick={()=>setPaused(!paused)} aria-pressed={paused}>{paused?<Play size={12}/>:<Pause size={12}/>} {paused?"Resume motion":"Pause motion"}</button></div>
   </section>
